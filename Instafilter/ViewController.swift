...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func applyProcessing() {
        ...
        if inputKeys.contains(kCIInputIntensityKey) { // Not all filters support changing intensity.
            currentFilter.setValue(intensity.value, forKey: kCIInputIntensityKey) // uses the value of intensity slider to set the kCIInputIntensityKey value of our current Core Image filter. 0 means "no effect", 1 means "fully sepia."
